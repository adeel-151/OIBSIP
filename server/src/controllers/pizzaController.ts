...
export const getAllPizzas = async (req: any, res: any, next: any) => {
  try {
...
export const getFeaturedPizzas = async (req: any, res: any, next: any) => {
  try {
...
export const getPizzaById = async (req: any, res: any, next: any) => {
  try {
