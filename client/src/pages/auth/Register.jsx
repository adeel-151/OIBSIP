...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex font-sans bg-background">
      ...
      {/* Left Panel - Form */}
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-background order-2 lg:order-1">
        <motion.div 
        ...
        >
          ...
          <div className="mb-8">
            <h2 className="text-4xl font-['Chewy'] text-foreground mb-2 tracking-wide">Create Account</h2>
          ...
          <p className="text-center mt-8 text-muted-foreground">
            ...
            <Link to="/login" className="text-red-500 font-bold hover:text-red-600 transition-colors">
              Sign in
            </Link>
          </p>
        </motion.div>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-foreground items-center justify-center order-1 lg:order-2">
        {/* Background decorations */}
        <div className="absolute top-20 left-10 opacity-30 text-red-500">
           <svg viewBox="0 0 24 24" fill="currentColor" stroke="none" className="w-20 h-20"><circle cx="12" cy="12" r="10"/></svg>
        </div>
        
        <div className="absolute inset-0 bg-red-500 rounded-full blur-3xl opacity-10 scale-90 translate-x-1/4"></div>
        ...
        <div className="relative z-10 flex flex-col items-center text-center p-12">
          ...
          <img 
            src={FEATURED_PIZZA} 
            alt="Delicious Pizza" 
            className="w-[80%] max-w-[450px] object-cover rounded-[3rem] shadow-2xl ring-8 ring-background/10 transform rotate-3 mb-8"
          />
