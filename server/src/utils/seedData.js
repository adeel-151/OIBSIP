...
const ingredients = [
  ...
  { name: 'Hand Tossed', category: 'BASE', price: 20, image: 'base-hand.png' },
  { name: 'Cheese Burst', category: 'BASE', price: 100, image: 'base-cheese.png' },
  { name: 'Whole Wheat', category: 'BASE', price: 30, image: 'base-wheat.png' },
  { name: 'Italian Herb', category: 'BASE', price: 40, image: 'base-herb.png' },
  
  { name: 'Classic Tomato', category: 'SAUCE', price: 0, image: 'sauce-tomato.png' },
  { name: 'Spicy Marinara', category: 'SAUCE', price: 10, image: 'sauce-spicy.png' },
  { name: 'Creamy Garlic', category: 'SAUCE', price: 20, image: 'sauce-garlic.png' },
  { name: 'BBQ', category: 'SAUCE', price: 20, image: 'sauce-bbq.png' },
  { name: 'Pesto', category: 'SAUCE', price: 30, image: 'sauce-pesto.png' },
  
  { name: 'Mozzarella', category: 'CHEESE', price: 0, image: 'cheese-mozzarella.png' },
  { name: 'Cheddar', category: 'CHEESE', price: 30, image: 'cheese-cheddar.png' },
  { name: 'Parmesan', category: 'CHEESE', price: 40, image: 'cheese-parmesan.png' },
  { name: 'Four Cheese', category: 'CHEESE', price: 60, image: 'cheese-four.png' },
  { name: 'Vegan Cheese', category: 'CHEESE', price: 50, image: 'cheese-vegan.png' },
  
  { name: 'Mushrooms', category: 'VEGETABLE', price: 20, image: 'veg-mushroom.png' },
  { name: 'Onions', category: 'VEGETABLE', price: 10, image: 'veg-onion.png' },
  { name: 'Bell Pepper', category: 'VEGETABLE', price: 15, image: 'veg-bell.png' },
  { name: 'Olives', category: 'VEGETABLE', price: 25, image: 'veg-olive.png' },
  { name: 'Jalapeños', category: 'VEGETABLE', price: 20, image: 'veg-jalapeno.png' },
  { name: 'Tomatoes', category: 'VEGETABLE', price: 10, image: 'veg-tomato.png' },
  { name: 'Corn', category: 'VEGETABLE', price: 15, image: 'veg-corn.png' },
  { name: 'Spinach', category: 'VEGETABLE', price: 20, image: 'veg-spinach.png' },
];
...
const seedData = async () => {
  try {
    ...
    // Seed Admin
    const adminExists = await Admin.findOne({ email: 'admin@pizzaro.com' });
    if (!adminExists) {
